			...
			<div class="row">
				...
				<p>Right now we are forwarding to our phase 2.
				   <p><em>Our phases :-</em></p>
					<li>Phase 1 : Exterior design of building.</li>
					<li>Phase 2 : Fences , roads , layouts , etc.</li>
					<li>Phase 3 : Building interiors.</li>
					<li>Phase 4 : Modifications.</li>
				</p>
				<p>Thanks for reading. Enjoy viewing our website. We really appreciate your suggestions, so, please mail your suggestions at <strong>< ashuah65@gmail.com ></strong> (for any issues related to buildings, layouts and 3-D models) or <strong>< nitinmi210.nitb@gmail.com ></strong> (for any issues related to the content on website). <em>Please like our facebook page <strong>"DMM"</strong> (which is searchable as the name <strong>"@Dmm005"</strong>) and subscribe our "YouTube" channel</em>. The links to our <em>social media platforms are at the below section i.e. at the footer of this webpage</em>.</p>
